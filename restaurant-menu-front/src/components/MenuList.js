import axios from "axios";
    ...
    export const MenuList = () => {
      ...
      useEffect(() => {
        // to retrieve all menus from the API and set the response objects in menus by using setMenus 
        retrieveAllMenus();
      }, [countRef]);
      ...
      // to delete a menu and set the deleted state to true, which will help us 
      // show a simple message every time a menu is deleted
      const deleteMenu = (id) => {
        axios
